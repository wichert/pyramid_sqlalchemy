...
def includeme(config):
    ...
    """
    config.add_directive('enable_sql_two_phase_commit',
                         enable_sql_two_phase_commit)
    config.add_request_method('sql_session', get_sql_session, reify=True)
    config.add_request_method('sql_query', get_sql_query)
